...
//                                     onChange={(e) => setPaymentMethod(e.target.value)}
//                                 />
//                                 <label htmlFor="bank">Thanh toán qua tài khoản ngân hàng</label>
//                             </div>
//                         </div>
...
function Payment({ room, fromDate, toDate, totaldays, totalamount, service }) {
    ...
    useEffect(() => {
        if (paymentMethod === "paypal" && !paypalLoaded) {
            ...
            script.src = `https://www.paypal.com/sdk/js?client-id=Ac3dVbjHCtGKwVU9vBV8jB1NuVaKa9PKwQCS5MqAlKodap8IuqeYT1VV2H8-rpQO3unZK-MczCIsvmDD&currency=USD`;
            script.async = true;
